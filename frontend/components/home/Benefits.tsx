        ...
        <div className="flex justify-end">
          <div className="max-w-3xl text-right">
            ...
            <p className="text-text-muted mt-3 text-base leading-7">
              Коли вдома одночасно працюють ноутбук, телевізор і кілька
              телефонів, важлива не лише цифра в тарифі, а й стабільна мережа,
              швидке підключення та нормальна підтримка
            </p>
          </div>
        </div>

        <div className="mt-10 grid gap-4 md:grid-cols-1 xl:grid-cols-2">
          {benefits.map((item) => {
            ...
            return (
              ...
              >
                <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_100%_50%,rgba(255,255,255,0.05),transparent_40%),linear-gradient(170deg,rgba(255,255,255,0.025),transparent_34%)]" />
